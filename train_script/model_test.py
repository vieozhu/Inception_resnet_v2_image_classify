...
import time
import os
from model_train import dataset_dir as ds_dir
from model_train import log_dir as logg_dir
from model_train import get_split, load_batch
...
log_eval = '/path/to/log_1_eval_test'
